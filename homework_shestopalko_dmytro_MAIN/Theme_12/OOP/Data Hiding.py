...
# which involves packaging of related variables and functions into a single easy-to-use object -
...
s = Spam()
s.print_egg()
print(s._Spam__egg) #we are accessing the private attribute __egg from outside the class Spam
print(s__egg)
